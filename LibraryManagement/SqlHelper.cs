...
namespace Quanlythuvien
{
	...
	public class SqlHelper
	{
		...
		public static string ConnectString="Integrated Security=SSPI;Data Source=KUBOM-PC\\SQLEXPRESS;Initial Catalog=quanlythuvien;User ID=sa;Password=";
		...
		//public static string ConnectString="data source=.;database=quanlithuvien;uid=sa;password=";
		public SqlHelper()
		{
			//
